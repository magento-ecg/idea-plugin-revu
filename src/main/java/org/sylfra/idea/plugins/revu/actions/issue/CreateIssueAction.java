...
public class CreateIssueAction extends AbstractIssueAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        CharSequence fragment = document.getCharsSequence().subSequence(
                document.getLineStartOffset(selectionStart),
                document.getLineEndOffset(selectionEnd)
        );

        issue.setFile(vFile);
        issue.setLineEnd(selectionEnd);
        issue.setLineStart(selectionStart);
